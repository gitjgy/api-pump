...
//	@Setter @Getter @ApiModelProperty(value="数据长度") private String datalenth;
	@Setter @Getter @ApiModelProperty(value="操作人") private String person;
...
//	@Setter @Getter @ApiModelProperty(value="物料数量（数字）") private long materialnum;
	...
	@Setter @Getter @ApiModelProperty(value="操作时间（限19位字符）",example="例如：2018-01-09 19:29:59",required=true) private String operatetime;
